...
import _ from 'lodash'; // lodash is not used, so we can remove it
    ...
    <>
      ...
      {openModal && (
        ...
        >
          <div
            id="uploadModal"
            className="w-[90vw] max-w-[90vw] bg-[#d9d9d9] rounded-4xl flex flex-col justify-between p-4 max-h-[95vh] overflow-y-auto drop-shadow-lg"
