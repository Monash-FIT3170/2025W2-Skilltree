...
export const EventLeaderboardModal = ({ eventId }) => {
    const [isOpen, setIsOpen] = useState(false);
      ...
      return (
        <>
            <Modal show={isOpen} onClose={() => setIsOpen(false)} dismissible size="7xl">
                <ModalHeader>
            ...
            <button className="cursor-pointer w-full sm:w-auto bg-[#328E6E] text-white font-semibold py-2 px-4 rounded-lg shadow hover:bg-[#2a7d60] transition-colors" onClick={() => setIsOpen(true)}>
                Leaderboard
            </button>
        </>
      );
