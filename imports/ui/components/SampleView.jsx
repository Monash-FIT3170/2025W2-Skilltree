        ...
        { 
          samples.map(sample =>
            <li key={sample._id} className="mb-1">
              ...
              <button onClick={() => copiesAddOne(sample._id)} className="bg-gray-500 text-white py-1 px-2 rounded mt-3 hover:bg-gray-600 active:bg-gray-400"> +1 </button>
              <button onClick={() => copiesSubOne(sample._id)} className="bg-gray-500 text-white py-1 px-2 rounded mt-3 hover:bg-gray-600 active:bg-gray-400"> -1 </button>
            </li>
          )
        }
      </ul>
