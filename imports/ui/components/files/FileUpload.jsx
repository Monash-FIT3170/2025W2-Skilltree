...
class FileUploadComponent extends Component {
  ...
  render() {
    if (!this.props.docsReadyYet || !Array.isArray(this.props.files)) {
...
export default withTracker(props => {
  ...
  console.log('[Tracker] typeof files:', typeof files);
  console.log('[Tracker] files isArray:', Array.isArray(files));
