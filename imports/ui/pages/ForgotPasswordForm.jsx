                ...
                <div className="bg-white rounded-xl shadow-2xl p-6 sm:p-8">
                    <div className='text-center mb-8'>
                        ...
                        <div className='space-y-2 text-center mb-6'>
                            ...
                            <p className='text-sm sm:text-base text-gray-600'>Enter your Skilltree email below and we'll send you a link to reset it.</p>
                        </div>

                        {/*Email Submit Form */}
                        <form onSubmit={handleForgotPasswordForm} className='space-y-6 mt-12'>
