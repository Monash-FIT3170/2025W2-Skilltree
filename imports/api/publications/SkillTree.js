  ...
  const dummySkillTrees = [
    {
      ...
      skillNodes: [
        { id: "dribble", type: "input", data: { label: "Dribbling" }, position: { x: 100, y: 100 } },
        { id: "shoot", type: "default", data: { label: "Shooting" }, position: { x: 300, y: 100 } },
        { id: "defend", type: "output", data: { label: "Defensive Skills" }, position: { x: 500, y: 100 } }
      ],
      skillEdges: [
    ...
    },
    {
      ...
      termsAndConditions: "Content for personal development in football skills.",
      tags: ["football", "soccer", "sports"],
      skillNodes: [
        { id: "pass", type: "input", data: { label: "Passing" }, position: { x: 100, y: 100 } },
        { id: "shoot", type: "default", data: { label: "Shooting" }, position: { x: 300, y: 100 } },
        { id: "goalkeep", type: "output", data: { label: "Goalkeeping" }, position: { x: 500, y: 100 } }
      ],
      skillEdges: [
    ...
    },
    {
      ...
      skillNodes: [
        { id: "bat", type: "input", data: { label: "Batting" }, position: { x: 100, y: 100 } },
        { id: "bowl", type: "default", data: { label: "Bowling" }, position: { x: 300, y: 100 } },
        { id: "field", type: "output", data: { label: "Fielding" }, position: { x: 500, y: 100 } }
      ],
      skillEdges: [
    ...
    },
    {
      ...
      skillNodes: [
        { id: "serve", type: "input", data: { label: "Serving" }, position: { x: 100, y: 100 } },
        { id: "rally", type: "default", data: { label: "Rally Techniques" }, position: { x: 300, y: 100 } },
        { id: "strategy", type: "output", data: { label: "Match Strategy" }, position: { x: 500, y: 100 } }
      ],
      skillEdges: [
